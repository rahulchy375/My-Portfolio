        ...
        <div className="dark:text-white">
          <div className="">
            <div className="sm:flex items-center justify-between">
              <h2 ref={title} className="text-[25px] sm:text-[30px] lg:text-[40px] font-bold">
                Contact{" "}
            ...
            <p ref={para} className="mt-[15px] text-[#8A8FB9] md:text-[18px] lg:text-[20px] dark:text-white">
          ...
          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center">
            <div ref={inputs} className="my-[30px] order-2 w-full sm:order-1 sm:w-[48%] xl:w-[49%]">
            ...
            <div className="order-1 sm:order-2 mt-[30px] sm:w-[48%] xl:w-[49%]" ref={map}>
              <iframe
