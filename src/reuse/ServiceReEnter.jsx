  ...
  return (
    <>
      <div className="services w-[260px] xl:w-[19.5%]">
        <div
          className={` bg-[#fbf3f1] dark:bg-[#083336] rounded-[5px] pt-[20px] px-[10px] mt-[30px] hover:shadow-serviceLight dark:hover:shadow-serviceDark duration-300`}
        >
          <div
